...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |-------------+------+------+------+------+------+------+------+------+------+------+------+------+------+-------------|
   * | Ctrl |  FN  |  ALT ||||||||  WIN | Home | Space|  Del |||||||| Enter| Space| PGUP | PGDN |||||||| Left | Down | Right|
   * ,----------------------------------------------------------------------------------------------------------------------.
   */
  [_QWERTY] = LAYOUT( \
    ...
    KC_LSFT,  KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,             RAISE,           LOWER,            KC_N,    KC_M, KC_COMM, KC_DOT,  KC_UP, KC_RSFT, \
    KC_LCTL,    FN, KC_LALT,          KC_LGUI, KC_HOME,    KC_SPC ,KC_DEL,          KC_ENT,KC_SPC , KC_PGUP, KC_PGDN         ,KC_LEFT,KC_DOWN, KC_RGHT  \
  ),
   ...
   * | Shift|      |      |      |      |      |||||||| Raise|      | Lower||||||||      |      |      |      |  UP  | Shift|
   * |-------------+------+------+------+------+------+------+------+------+------+------+------+------+------+-------------|
   * | Ctrl |  FN  |  ALT ||||||||  WIN | Home | Space|  INS |||||||| Enter| Space| PGUP | PGDN |||||||| Left | Down | Right|
   * ,----------------------------------------------------------------------------------------------------------------------.
   */
  [_RAISE] = LAYOUT(
    XXXXXXX,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,  KC_F11,                         KC_F12,   KC_F6,   KC_F7,   KC_F8,  KC_F9,   KC_F10, XXXXXXX, \
