...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------+--------------------+------+------+------+------+------+------+------|
   * | F/H  |   A  |   S  |   D  |   F  |   G  |   \  |                    |   /  |   H  |   J  |   K  |   L  |   ;  | Enter|
   * |------+------+------+------+------+------+---------------------------+------+------+------+------+------+------+------|
   * | Shift|   Z  |   X  |   C  |   V  |   B  |||||||| Raise|      | Lower||||||||   N  |   M  |   ,  |   .  |  UP  |  '   |
   * |-------------+------+------+------+------+------+------+------+------+------+------+------+------+------+-------------|
  ...
  [_QWERTY] = LAYOUT( \
    ...
    KC_FFHF,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_BSLS,                        KC_SLSH,    KC_H,    KC_J,    KC_K,   KC_L,KC_SCLN,  KC_ENT, \
    KC_LSFT,  KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,             RAISE,           LOWER,            KC_N,    KC_M, KC_COMM, KC_DOT,  KC_UP, KC_QUOT, \
  ...
  [_LOWER] = LAYOUT(
    ...
    XXXXXXX, KC_LEFT, KC_DOWN, KC_RGHT, XXXXXXX, XXXXXXX, XXXXXXX,                        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______, \
    _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,         _______,       _______,          XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______, XXXXXXX, \
  ...
  [_RAISE] = LAYOUT(
    ...
    XXXXXXX, KC_HOME, KC_PGDN,  KC_END, XXXXXXX, XXXXXXX, XXXXXXX,                        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______, \
    _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,         _______,       _______,          XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______, XXXXXXX, \
    _______, _______, _______,          _______, _______, _______, KC_INS,       _______, _______, _______, _______,          _______, _______, _______ \
  ),
  ...
  [_ADJUST] = LAYOUT(
    ...
    XXXXXXX, XXXXXXX, RGB_MOD, RGB_SAD, RGB_SAI, XXXXXXX, XXXXXXX,                       XXXXXXX, XXXXXXX, BL_BRTG, XXXXXXX, XXXXXXX, XXXXXXX, _______, \
    _______, XXXXXXX, XXXXXXX, RGB_VAD, RGB_VAI, XXXXXXX,         _______,       _______,         XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______, XXXXXXX, \
    _______, _______, _______,          _______, _______, _______, KC_INS,       _______,_______, _______, _______,          _______, _______, _______ \
  ),
